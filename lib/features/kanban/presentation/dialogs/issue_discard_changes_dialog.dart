...
class IssueDiscardChangesDialog extends StatelessWidget {
  final VoidCallback onConfirm;

  const IssueDiscardChangesDialog({super.key, required this.onConfirm});
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Discard unsaved changes?', style: AppStyling.headingMd),
            const SizedBox(height: AppStyling.spaceSm),
            Text("Your edits haven't been committed and will be lost.", style: AppStyling.bodySm),
