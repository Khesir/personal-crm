        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text('Publish updates to Keep Track users',
                  style: AppStyling.bodySm),
            ],
          ),
          const Spacer(),
...
class _AnnouncementCard extends StatelessWidget {
  ...
  Color _typeColor(AnnouncementType type) => switch (type) {
        ...
        AnnouncementType.release => AppColors.accentKeepTrack,
              ...
              Row(
                children: [
                  Switch(
                    ...
                    activeColor: AppColors.accentKeepTrack,
                  ),
                  const SizedBox(width: AppStyling.spaceSm),
