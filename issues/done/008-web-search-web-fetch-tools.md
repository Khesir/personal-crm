...
Implemented 2026-06-18. Created tools/registry.py and tools/web.py (web_search + web_fetch via httpx + SearXNG). Updated main.py chat loop to multi-turn tool dispatch. test_tools.py: all tests passing.
