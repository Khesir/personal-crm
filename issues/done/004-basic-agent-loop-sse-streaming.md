...
Implemented 2026-06-18. Added POST /chat endpoint to main.py with SSE streaming. Loop calls active provider, streams text chunks, emits done/error events. test_chat.py: 3 tests passing.
