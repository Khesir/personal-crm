...
Implemented 2026-06-19. Created tools/memory.py with memory_read (returns null for missing/invalid files) and memory_write (overwrites full file, errors if no brain_path). Updated main.py to call set_brain_path per request. test_memory.py: all tests passing.
