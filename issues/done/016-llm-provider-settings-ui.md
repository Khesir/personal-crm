...
Implemented 2026-06-18. Created AgentConfigDatasource for GET/POST /config. Created AgentSettingsSection with provider dropdown, model field, API key (masked, cloud-only), and port field with restart note. Added to settings navigation.
