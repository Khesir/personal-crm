...
Implemented 2026-06-18. Added workingProjectName to AgentStateData. Added setWorkingProject to AgentController. ChatPane header now shows project picker (PopupMenuButton) loading from ProjectsRepository. Tests updated and passing.
