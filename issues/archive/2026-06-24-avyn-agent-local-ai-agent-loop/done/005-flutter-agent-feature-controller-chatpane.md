...
Implemented 2026-06-18. Created features/agent/ module with AgentController, AgentRepository, AgentDatasource, event models, DI. Rewrote ChatPane as proper chat UI backed by AgentController. Tests passing.
